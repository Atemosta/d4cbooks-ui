    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          ...
          <p className="sub-text">{"D4Books is a simple and affordable alternative for expense tracking of receipts and item warranties."}</p>
          <p className="sub-text">{"D4CBooks is currently FREE during our initial launch."}</p>
          <img
            src={imgNotes}
          ...
          <p className="sub-text">{"1. Log in with your social account or external wallet"}</p>
